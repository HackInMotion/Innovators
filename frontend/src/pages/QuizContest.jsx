...
const QuizContest = () => {
  ...
  const handleFinish = async () => {
    ...
    const discountCode = `CODE${discount}${Math.random()
      .toString(36)
      .substring(2, 6)
      .toUpperCase()}`;
  ...
  const shareResults = () => {
    if (navigator.share) {
      ...
      alert(
        `Share your results: I scored ${score} points and earned ${discountEarned}% off!`
      );
    }
  };
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Test your {category} knowledge at {difficulty} level, earn
            discounts, and compete!
          </p>
        </div>
              ...
              {discountEarned > 0 ? (
                <div className="bg-gradient-to-r from-green-600/20 to-emerald-600/20 p-6 rounded-lg border border-green-500/30 mb-8">
                  ...
                  <p className="text-gray-300 mb-4">
                    You've earned a {discountEarned}% discount on all our
                    premium coding courses! Use code{" "}
                ...
                <div className="bg-gradient-to-r from-blue-600/20 to-indigo-600/20 p-6 rounded-lg border border-blue-500/30 mb-8">
                  ...
                  <p className="text-gray-300 mb-4">
                    You didn't earn a discount this time, but don't worry! Try
                    again after brushing up on your skills.
                  </p>
                  <div className="flex space-x-4">
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-sm text-gray-400 flex justify-between">
                        <span>
                          {user.score} points ({user.difficulty})
                        </span>
