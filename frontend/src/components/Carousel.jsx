            ...
            <div className="container mx-auto px-6 z-10 text-white">
              <div className="max-w-2xl space-y-4">
                ...
                <p className="text-lg text-gray-200">
                  We offer flexible learning options to help you reach your
                  potential, all from the comfort of your home.
                </p>
                <div className="flex space-x-4 pt-4">
                  <button className="px-6 py-3 bg-blue-600 hover:bg-blue-700 rounded-md font-medium transition-colors" onClick={()=>navigate('/courses')}>
                    Find Courses
                  </button>
          ...
          <div className="relative w-full h-full bg-hero-2 flex items-center">
            ...
            <div className="container mx-auto px-6 z-10 text-white">
              <div className="max-w-2xl space-y-4">
                ...
                <p className="text-lg text-gray-200">
                  Join our platform to gain in-demand skills and transform your
                  career with expert-led courses.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative w-full h-full bg-hero-3 flex items-center">
            ...
            <div className="container mx-auto px-6 z-10 text-white">
              <div className="max-w-2xl space-y-4">
                ...
                <p className="text-lg text-gray-200">
                  Access high-quality online courses that allow you to learn at
